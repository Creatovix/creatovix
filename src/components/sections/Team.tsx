...
const team = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=600&h=800&fit=crop&crop=face',
...
export default function Team() {
  ...
  return (
    <section ref={sectionRef} id="team" style={{ background: '#F5F3F0' }}>
      ...
      <div style={{ padding: 'clamp(4rem, 8vw, 6rem) 0 clamp(2rem, 4vw, 3rem)', textAlign: 'center' }}>
        ...
        <h2 style={{ 
          ...
          Meet the experts<br />behind the code.
        </h2>
      ...
      >
        <div className="container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', padding: 'clamp(2rem, 4vw, 4rem) 0' }}>
          <div style={{ 
            display: 'grid', 
